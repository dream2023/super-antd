import { ApiType, castToObj, changeObjValueToUndefined, processError, processSuccess, processFormatResult, getAxiosOptions, serviceFn } from "super-antd";
...
describe('useAxios util', () => {
  ...
  describe('getAxiosOptions', () => {
    ...
    test('当 api 为对象时，应保留原 axios 配置内容', () => {
      ...
      expect(getAxiosOptions({ api })).toEqual({ url: '/user', baseURL: 'https://foo.com', data: undefined, params: undefined })
    })
