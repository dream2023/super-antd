...
import { withOptions, WithOptionsProps, WithOptionsConfigType, SuperForm, OptionsType, SuperProvider, SuperInput } from 'super-antd'
...
const resOptions = [{ label: 'a', value: 1 }, { label: 'b', value: 2 }]
...
describe('withOptions', () => {
  ...
  test('需要转换的数据', () => {
    render(<App options={[{ name: 'a', id: 1 }, { name: 'b', id: 2 }]} optionsProp={{ labelKey: 'name', valueKey: 'id' }} />)
    toBe({ options: resOptions })
  })
  ...
  test('需要 data', () => {
    render(<App needData options={[{ name: 'a', id: 1 }, { name: 'b', id: 2 }]} optionsProp={{ labelKey: 'name', valueKey: 'id' }} />)
